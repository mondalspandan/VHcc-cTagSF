	OUTPUTDIR=/nfs/dust/cms/user/spmondal/ctag_condor/190117/
	...
	INPFILE=$3
        ...
        tmp_dir=$(mktemp -d)
        cp -r ../Wlvhcc_nano.py ../nuSolutions.py ../scalefactors $tmp_dir
        ...
        #xrdcp -d 1 -f root://xrootd-cms.infn.it//${INPFILE} ./infile.root
        echo "running python script"
        python Wlvhcc_nano.py ${INPFILE}
        rc=$?
        if [[ $rc != 0 ]]
        then
