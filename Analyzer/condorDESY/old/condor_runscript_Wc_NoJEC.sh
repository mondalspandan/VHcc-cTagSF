	OUTPUTDIR=/nfs/dust/cms/user/spmondal/ctag_condor/190923_2017_Wc/
	...
	INPFILE=$3
        ...
        tmp_dir=$(mktemp -d)
        cp -r ../WcSelection.py ../nuSolutions.py ../scalefactors* $tmp_dir
	...
	until cp -vf ${OUTPUTNAME} ${OUTPUTDIR}${SAMPNAME}"/outTree_"${CONDOR_PROCESS_ID}"_NEW3.root"; do
