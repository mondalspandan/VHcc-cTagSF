	export OUTPUTDIR=/nfs/dust/cms/user/spmondal/ctag_condor/201030_2016Nanov7_$4/
...
#             PYFILE="WcNoMuSelection.py"
        ...
        tmp_dir=$(mktemp -d)
        cp -r ../${PYFILE} ../nuSolutions.py ../scalefactors* getJEC.py processInput.py SkimNano.py $tmp_dir
