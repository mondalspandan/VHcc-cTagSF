outDir = "190215_pt20"
DYPath = "/nfs/dust/cms/user/spmondal/ctag_condor/190206_DY_pt20/"
TTPath = "/nfs/dust/cms/user/spmondal/ctag_condor/190213_TT_pt20_2/"
...
def applyCuts(ln,reg=""):
    ...
    if "central" in syst:
        # ln = ln.replace('TTWEIGHTE','MCWeightName="eventWeightUnsigned",DataWeightName="eventWeightUnsigned",yTitle="OS+SS Events",outDir="OUTDIR_SYSTNAME"')
        # ln = ln.replace('TTWEIGHTM','MCWeightName="eventWeightUnsigned",DataWeightName="eventWeightUnsigned",yTitle="OS+SS Events",outDir="OUTDIR_SYSTNAME"')
        ...
        # ln = ln.replace('TTWEIGHTE','MCWeightName="eventWeightUnsigned",DataWeightName="eventWeightUnsigned",yTitle="OS+SS Events",outDir="OUTDIR_SYSTNAME",MCStat="SYSTNAME"')
        # ln = ln.replace('TTWEIGHTM','MCWeightName="eventWeightUnsigned",DataWeightName="eventWeightUnsigned",yTitle="OS+SS Events",outDir="OUTDIR_SYSTNAME",MCStat="SYSTNAME"')
        ...
        # ln = ln.replace('TTWEIGHTE','MCWeightName="eventWeightUnsigned",DataWeightName="eventWeightUnsigned",yTitle="OS+SS Events",outDir="OUTDIR_SYSTNAME",dataStat="SYSTNAME"')
        # ln = ln.replace('TTWEIGHTM','MCWeightName="eventWeightUnsigned",DataWeightName="eventWeightUnsigned",yTitle="OS+SS Events",outDir="OUTDIR_SYSTNAME",dataStat="SYSTNAME"')
        ...
        # ln = ln.replace('TTWEIGHTE','MCWeightName="eventWeightUnsigned",DataWeightName="eventWeightUnsigned",yTitle="OS+SS Events",outDir="OUTDIR_SYSTNAME",pathSuff="_SYSTNAME"')
        # ln = ln.replace('TTWEIGHTM','MCWeightName="eventWeightUnsigned",DataWeightName="eventWeightUnsigned",yTitle="OS+SS Events",outDir="OUTDIR_SYSTNAME",pathSuff="_SYSTNAME"')
        ...
        # ln = ln.replace('TTWEIGHTE','MCWeightName="eventWeightUnsigned",DataWeightName="eventWeightUnsigned",yTitle="OS+SS Events",outDir="OUTDIR_SYSTNAME",useXSecUnc="SYSTNAME"')
        # ln = ln.replace('TTWEIGHTM','MCWeightName="eventWeightUnsigned",DataWeightName="eventWeightUnsigned",yTitle="OS+SS Events",outDir="OUTDIR_SYSTNAME",useXSecUnc="SYSTNAME"')
    ...
    #     # ln = ln.replace('TTWEIGHTE','MCWeightName="eventWeightUnsigned*EleIDSF_DIRECTION",DataWeightName="eventWeightUnsigned",yTitle="OS+SS Events",outDir="OUTDIR_SYSTNAME"')
    #     # ln = ln.replace('TTWEIGHTM','MCWeightName="eventWeightUnsigned*MuIDSF_DIRECTION",DataWeightName="eventWeightUnsigned",yTitle="OS+SS Events",outDir="OUTDIR_SYSTNAME"')
    ...
    #     ln = ln.replace('WCWEIGHTM','MCWeightName="eventWeight*MuIDSF_DIRECTION",DataWeightName="eventWeight",yTitle="OS-SS Events",outDir="OUTDIR_SYSTNAME"')
    ...
    #     ln = ln.replace('DIRECTION',direc)
        ...
        # ln = ln.replace('TTWEIGHTE','MCWeightName="eventWeightUnsigned*SYSTNAME",DataWeightName="eventWeightUnsigned",yTitle="OS+SS Events",outDir="OUTDIR_SYSTNAME"')
        # ln = ln.replace('TTWEIGHTM','MCWeightName="eventWeightUnsigned*SYSTNAME",DataWeightName="eventWeightUnsigned",yTitle="OS+SS Events",outDir="OUTDIR_SYSTNAME"')
...
arguments = '''
           ...
           ["jet_CvsL","muJet_idx"],"CvsL",5,0,1,TTSELME,TTCUTME,dataset="smu",brName2D=["jet_CvsB","muJet_idx"],brLabel2="CvsB",nbins2=5,CVXBINNING,drawStyle="",filePre="TT_me",makeROOT=True,TTWEIGHT
...
onlyCentral = '''
#            "jetMu_Pt",r"p^{soft #mu}_{T} [GeV] (mu)",25,0,25,MSEL,MCUT,dataset="smu",WCWEIGHTM
#            "jetMu_Pt",r"p^{soft #mu}_{T} [GeV] (e)",25,0,25,ESEL,ECUT,dataset="sele",WCWEIGHT
#           ["jet_Pt","muJet_idx"],r"p^{jet}_{T} [GeV] (mu)",25,0,100,MSEL,MCUT,dataset="smu",WCWEIGHTM
#            ["jet_Pt","muJet_idx"],r"p^{jet}_{T} [GeV] (e)",25,0,100,ESEL,ECUT,dataset="sele",WCWEIGHT
#            ["jet_Eta","muJet_idx"],r"#eta_{jet} (mu)",20,-2.8,2.8,MSEL,MCUT,dataset="smu",WCWEIGHTM
#            ["jet_Eta","muJet_idx"],r"#eta_{jet} (e)",20,-2.8,2.8,ESEL,ECUT,dataset="sele",WCWEIGHT
#            ["jet_Phi","muJet_idx"],r"#phi_{jet} (mu)",20,-3.2,3.2,MSEL,MCUT,dataset="smu",WCWEIGHTM
#            ["jet_Phi","muJet_idx"],r"#phi_{jet} (e)",20,-3.2,3.2,ESEL,ECUT,dataset="sele",WCWEIGHT

#              ["jet_CvsL","muJet_idx"],r"Jet CvsL (mu)",25,0,1,MSEL,MCUT,dataset="smu",makeROOT=True,WCWEIGHTM
#              ["jet_CvsL","muJet_idx"],r"Jet CvsL (e)",25,0,1,ESEL,ECUT,dataset="sele",makeROOT=True,WCWEIGHT
#              ["jet_CvsB","muJet_idx"],r"Jet CvsB (mu)",25,0,1,MSEL,MCUT,dataset="smu",makeROOT=True,WCWEIGHTM
#              ["jet_CvsB","muJet_idx"],r"Jet CvsB (e)",25,0,1,ESEL,ECUT,dataset="sele",makeROOT=True,WCWEIGHT
#

#             "jetMu_Pt",r"p^{soft #mu}_{T} [GeV] (mu)",25,0,25,TTSELM,TTCUTM,dataset="smu",makeROOT=True,TTWEIGHTM
#             "jetMu_Pt",r"p^{soft #mu}_{T} [GeV] (e)",25,0,25,TTSELE,TTCUTE,dataset="sele",makeROOT=True,TTWEIGHTE
#            ["jet_Pt","muJet_idx"],r"p^{jet}_{T} [GeV] (mu)",25,0,100,TTSELM,TTCUTM,dataset="smu",makeROOT=True,TTWEIGHTM
#            ["jet_Pt","muJet_idx"],r"p^{jet}_{T} [GeV] (e)",25,0,100,TTSELE,TTCUTE,dataset="sele",makeROOT=True,TTWEIGHTE
#            ["jet_Eta","muJet_idx"],r"#eta_{jet} (mu)",20,-2.8,2.8,TTSELM,TTCUTM,dataset="smu",makeROOT=True,TTWEIGHTM
#            ["jet_Eta","muJet_idx"],r"#eta_{jet} (e)",20,-2.8,2.8,TTSELE,TTCUTE,dataset="sele",makeROOT=True,TTWEIGHTE
#            ["jet_Phi","muJet_idx"],r"#phi_{jet} (mu)",20,-3.2,3.2,TTSELM,TTCUTM,dataset="smu",makeROOT=True,TTWEIGHTM
#            ["jet_Phi","muJet_idx"],r"#phi_{jet} (e)",20,-3.2,3.2,TTSELE,TTCUTE,dataset="sele",makeROOT=True,TTWEIGHTE
#              ["jet_CvsL","muJet_idx"],r"Jet CvsL (mu)",25,0,1,TTSELM,TTCUTM,dataset="smu",makeROOT=True,TTWEIGHTM
#              ["jet_CvsL","muJet_idx"],r"Jet CvsL (e)",25,0,1,TTSELE,TTCUTE,dataset="sele",makeROOT=True,TTWEIGHTE
#              ["jet_CvsB","muJet_idx"],r"Jet CvsB (mu)",25,0,1,TTSELM,TTCUTM,dataset="smu",makeROOT=True,TTWEIGHTM
#              ["jet_CvsB","muJet_idx"],r"Jet CvsB (e)",25,0,1,TTSELE,TTCUTE,dataset="sele",makeROOT=True,TTWEIGHTE
#


#            ["jet_Phi","muJet_idx"],r"#phi_{jet}",20,-3.2,3.2,dataset="dmu",DYWEIGHT
#            ["jet_Eta","muJet_idx"],r"#eta_{jet}",20,-2.8,2.8,dataset="dmu",DYWEIGHT
